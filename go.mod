...
replace (
	...
	github.com/cosmos/ibc-go/v3 => github.com/calvinaco/ibc-go/v3 v3.0.0-hooks
	...
	github.com/tharsis/ethermint => github.com/calvinaco/ethermint v0.10.0-alpha1-cronos-7-ibc-go-v3.0.0-rc2-v0.0.1
