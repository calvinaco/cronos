...
const baseInterstakingPacketData: object = {}

export const InterstakingPacketData = {
  encode(message: InterstakingPacketData, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): InterstakingPacketData {
    ...
    const message = { ...baseInterstakingPacketData } as InterstakingPacketData
