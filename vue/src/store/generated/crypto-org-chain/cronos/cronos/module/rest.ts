 ...
 */
export type CronosMsgConvertVouchersResponse = object;

/**
 * MsgTransferTokensResponse defines the TransferTokens response type.
 */
export type CronosMsgTransferTokensResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  queryContractByDenom = (denom: string, params: RequestParams = {}) =>
    this.request<CronosContractByDenomResponse, RpcStatus>({
      path: `/cronos/v1/contract_by_denom/${denom}`,
      method: "GET",
      format: "json",
      ...params,
    });
